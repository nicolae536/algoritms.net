...
namespace algorithms.net.generic_algorithms
{
    ...
    public class AdiacencyGraph<TNode> : ICollection<TNode> where TNode : IComparable
    {
        ...
        public void AddVertex(TNode item, TNode neighboar, bool doubleWay = false)
        {
            ...
            GraphNode<TNode> nodeItem = nodesDictionary[item];
        ...
        public bool ContainsVertex(TNode parent, TNode child)
        {
            return nodesDictionary.ContainsKey(parent) &&
                nodesDictionary[parent].adicencyList.Contains(child);
        }
        ...
        public bool Remove(TNode item)
        {
            ...
            foreach (TNode adiacentNode in nodesDictionary[item].adicencyList)
            {
                GraphNode<TNode> neghboar = nodesDictionary[adiacentNode];
